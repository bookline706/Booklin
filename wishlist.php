...
$res=mysqli_query($con,"select product.name,product.image,product_attributes.price,product_attributes.mrp,product.id as pid,wishlist.id from product_attributes,product,wishlist where wishlist.product_id=product.id and product_attributes.product_id=product.id and wishlist.user_id='$uid'");
?>
                                ...
                                <table>
                                    <thead>
                                        <tr>
											...
											<th class="product-name">Add cart</th>
                                        </tr>
                                    </thead>
                                    <tbody>
										<?php
